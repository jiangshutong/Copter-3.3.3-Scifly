...
void AP_MotorsQuad::setup_motors()
{
    ...
    if( _flags.frame_orientation == AP_MOTORS_PLUS_FRAME ) {
        ...
        */
        ...
        add_motor_raw(AP_MOTORS_MOT_1,  -0.89113f,   0.89109f,   0.89111,   1);// at 52.13 degrees, arm length 362.11 mm
        add_motor_raw(AP_MOTORS_MOT_2,  1.0f,       -1.0f,       1,         3);// at -127.87 degrees, arm length 322.68 mm
        add_motor_raw(AP_MOTORS_MOT_3,  0.89113f,    0.89109f,   -0.89111,   4);// at -52.13 degrees, arm length 362.11 mm
